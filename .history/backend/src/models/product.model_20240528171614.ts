...
const ProductSchema = new Schema<IProduct>(
  {
    ...
    sexe: {
      type: String,
      enum: [
        ProductsSexeEnum.MEN,
        ProductsSexeEnum.WOMEN,
        ProductsSexeEnum.CHILD,
        ProductsSexeEnum.UNISEXE,
      ],
      default: ProductsSexeEnum.MEN,
      required: true,
    },
    deliveryDate: {
      type: Number,
