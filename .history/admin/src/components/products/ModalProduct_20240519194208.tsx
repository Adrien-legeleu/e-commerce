    ...
    <div className="fixed top-0 left-0 h-screen w-screen flex items-center justify-center">
      ...
      <div className="shadow-2xl bg-slate-50 w-1/2 z-10 py-10 px-20 rounded-3xl space-y-10 relative">
        <div className="absolute top-6 right-8 w-12 h-12">
          <div className="w-2 h-full bg-[#ca01017c] rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-45"></div>
          <div className="w-2 h-full bg-[#ca010177] rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-45"></div>
        </div>
