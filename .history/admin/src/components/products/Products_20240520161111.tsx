...
export const Products: React.FC<ProductsProps> = () => {
  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <div className="grid px-20 grid-cols-4  justify-center gap-16">
        {products.map((product, index) => (
          <div key={`product number : ${index}`} className="bg">
            <div className="relative group">
              ...
              />
              <div className="py-4 px-5 bg-[#FFFFFFC9] absolute bottom-0 left-0 w-full  translate-y-6 invisible  group-hover:translate-y-0 group-hover:visible group-hover:opacity-100 opacity-0 duration-300">
                <p>{product.color}</p>
                <p>{product.size}</p>
              </div>
            </div>
            <div className="mt-4">
              <h5 className="text-center ">{product.desc}</h5>
              <h4 className="text-center text-lg">{product.title}</h4>
              <ul>
                <li className="text-red-600 text-lg text-left">
                  {product.price} €
                </li>
                <li>
