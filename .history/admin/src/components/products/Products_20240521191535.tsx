            ...
            <Link to={`/${product._id}`}>
              ...
              >
                <div className="relative group group-hover:shadow-2xl duration-200 rounded-3xl">
                  ...
                  />
                  <div className="py-2 px-2 bg-[#FFFFFFC9] rounded-3xl absolute bottom-0 left-0 w-full  translate-y-5 invisible  group-hover:translate-y-0 group-hover:visible group-hover:opacity-100 opacity-0 duration-300">
