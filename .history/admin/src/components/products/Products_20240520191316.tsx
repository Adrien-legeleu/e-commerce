        ...
        {products.map((product, index) => (
          <div key={`product number : ${index}`} className="bg">
            <div className="relative group">
              ...
              />
              <div className="py-4 px-5 bg-[#FFFFFFC9] absolute bottom-0 left-0 w-full  translate-y-5 invisible  group-hover:translate-y-0 group-hover:visible group-hover:opacity-100 opacity-0 duration-300">
              ...
              >
                ...
                >
                  <g fill="none">
                    ...
                    <path
                      fill="black"
                      d="M20 5a1 1 0 1 1 0 2h-1l-.003.071l-.933 13.06A3 3 0 0 1 15.07 23H8.93a3 3 0 0 1-2.994-2.869L5.004 7H4a1 1 0 1 1 0-2h5.5V4A1.5 1.5 0 0 1 11 2.5h2A1.5 1.5 0 0 1 14.5 4v1H20zm-3.929 15.004L17 7H7l.929 13.004a1 1 0 0 0 .998.929h6.146a1 1 0 0 0 .998-.929zM13.5 4h-3v1h3V4z"
                    />
                  </g>
                </svg>
              </div>
