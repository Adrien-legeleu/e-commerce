                    ...
                    <ul className="flex gap-3 mt-4 whitespace-nowrap ">
                      {product.color.map((color: any, index: any) => {
                        if (index < 3) {
                          return (
                            <li
                              className={`min-w-8 min-h-6 rounded-full border-[1px] border-[#00000040]`}
                              key={`color : ${index}  `}
                        ...
                        if (index === 4) {
                          return (
                            <li
                              className={`min-w-8 min-h-6 rounded-full flex items-center justify-center border-[1px] border-[#00000040]`}
