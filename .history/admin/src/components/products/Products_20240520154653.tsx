        ...
        {products.map((product, index) => (
          <div key={`product number : ${index}`} className="bg">
            <div className="relative group">
              ...
              />
              <div className="py-4 px-5 bg-[#FFFFFFC9] absolute bottom-0 left-0 w-full  translate-y-4 invisible  group-hover:translate-y-0 group-hover:visible group-hover:opacity-100 opacity-0 duration-300">
                <p>{product.color}</p>
                <p>{product.size}</p>
              </div>
            </div>
