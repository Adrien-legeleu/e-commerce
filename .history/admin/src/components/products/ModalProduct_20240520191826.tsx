...
export const ModalProduct: React.FC<ModalProps> = ({
  ...
  const [dataProduct, setDataProduct] = useState<Partial<IProduct>>({
    ...
    qte: initialProductData?.qte || 0,
    price: initialProductData?.price || 0,
    deliveryDate: initialProductData?.deliveryDate || 0,
                ...
                return (
                  <div key={key}>
                    ...
                    <select
                      ...
                      id={key}
                      value={valueData}
                      onChange={(e) => changeProductValue(key as keyof IProduct, e.target.value)}
                    >
                ...
                return (
                  <div key={key}>
                    ...
                    <Select
                      ...
                      value={valueData}
                      onChange={(value) => changeProductValue(key as keyof IProduct, value)}
                      style={{ width: "100%" }}
                      options={sizeOptions}
                    />
                  </div>
