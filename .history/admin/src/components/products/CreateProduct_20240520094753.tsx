...
export const CreateProduct: React.FC<CreateProps> = ({ closeCreateModal }) => {
  ...
  return (
    <ModalProduct closeModal={closeCreateModal} createProduct={createProduct}  title="Your new Product" params={{title:true , desc:true , price:true , size:true , deliveryDate:true , color:true}} />
  );
};
