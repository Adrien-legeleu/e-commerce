      ...
      <div className="grid grid-cols-4 items-center justify-center gap-12">
        {products.map((product, index) => (
          <div key={`product number : ${index}`} className="bg">
            <div>
              <img
                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.paris-yorker.com%2Fchemises-homme-col-francais%2F523-3173-chemise-qualite-homme-col-francais-coton-popeline-noire-blanche.html&psig=AOvVaw0VtOmPiXQSYVTWFr1RTdAN&ust=1716298007113000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCPiwmbyqnIYDFQAAAAAdAAAAABAE"
