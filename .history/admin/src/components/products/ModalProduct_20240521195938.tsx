...
export const ModalProduct: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 h-full w-screen flex items-center justify-center">
      <div
        className="fixed top-0 left-0 h-full w-screen bg-[#00000060] backdrop-blur-sm"
        onClick={closeModal}
      ></div>
