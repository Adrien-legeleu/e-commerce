        ...
        {products.map((product, index) => (
          <div key={`product number : ${index}`} className="bg">
            <div className="relative group z-10">
              ...
              />
              <div className="py-4 px-5 bg-[#FFFFFFC9] absolute bottom-0 left-0 w-full  translate-y-16 -z-10 invisible  group-hover:translate-y-0 group-hover:visible group-hover:opacity-100 opacity-0 duration-300">
                <p>{product.color}</p>
                <p>{product.size}</p>
              </div>
            </div>
            <div className=" z-40 bg-red-900">
              <h4>{product.title}</h4>
              <li>{product.desc}</li>
              <li>{product.price}</li>
              <li>{product.qte}</li>
