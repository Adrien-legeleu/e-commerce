    ...
    <div className="h-full grid grid-cols-4 gap-10 px-8 items-center justify-center py-32">
      {products.map((product) => (
        <div
          ...
          className="rounded-3xl flex flex-col h-80 justify-between gap-5 py-5 px-8 group hover:scale-105 duration-200"
        >
          <h2 className="text-center text-xl capitalize">{product.title}</h2>
          <img
